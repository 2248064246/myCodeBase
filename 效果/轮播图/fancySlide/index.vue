<!--
 * @Author: ys4225/黄迎李
 * @Date: 2020-12-18 15:47:52
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2020-12-18 15:53:39
 * @Description: 
-->
<template>
  <div>
    <div class="demo-cont">
      ...
      <div class="demo-cont__credits">
        ...
        <img src="./image/blackwidow.jpg"
             alt=""
             class="demo-cont__credits-img" />
        <h3 class="demo-cont__credits-name">Nikolay Talanov</h3>
        <a href=""
           target="_blank"
           class="demo-cont__credits-link">My codepen</a>
        <a href=""
           target="_blank"
           class="demo-cont__credits-link">My twitter</a>
        ...
        <div class="colorful-switch">
          ...
          <label class="colorful-switch__label"
                 for="colorful-switch-cb">
